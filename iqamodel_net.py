...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            BTB(dim=dim, input_resolution=input_resolution,
    ...
    def __init__(self, img_size=384, patch_size=4, in_chans=3,  ffa_out_ch=32, tn_in_ch=384,
        ...
        for ind in range(4):
          sub_merge=nn.Sequential(
            ...
            MaxPool2d(kernel_size=window_size),
          )
        ...
        sub_fc = nn.Linear(int(embed_dim* (8/2**3)**2), tn_in_ch - ffa_out_ch * 3)  
        self.fcl_fc.append(sub_fc)
...
class HyperSwin4(nn.Module):
    ...
    def __init__(self, out_ch=1, ffa_out_ch=32, tn_in_ch=384, hyper_in_ch=384,
        ...
        super(HyperSwin4, self).__init__()
        ...
        self.avgpool = MaxPool2d(kernel_size=window_size)
